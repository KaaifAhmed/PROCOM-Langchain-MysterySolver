...
def solve_mystery(audio_text: str, doc_text: str, clue_text: str):
    ...
    # --- CRITICAL UPDATE: Combine context for the Chatbot ---
    full_context = f"""
    === MASTER TIMELINE ===
    {master_timeline}
    ...
    # Return Tuple: (Report, Context)
    return final_result, full_context